...
var _IStorageProvider = _interopRequireDefault(require("../../../shared/container/providers/StorageProvider/fakes/models/IStorageProvider"));
...
let UpdateUserAvatarService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  // injeção constructor(private usersRepository: IUsersRepository) {}
